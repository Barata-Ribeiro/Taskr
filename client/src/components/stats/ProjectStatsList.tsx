                    ...
                    {projects.map(project => {
                        ...
                        return (
                            <li key={project.id} className="col-span-1 flex rounded-md shadow-xs">
                                ...
                                <div className="flex flex-1 items-center justify-between truncate rounded-r-md border-t border-r border-b border-gray-200 bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">

...
import RegistrationSuccessToastr from "@/components/feedback/registration-success-toastr"
...
export default function LoginForm() {
    ...
    return (
        <>
            ...
            {searchParamsObject.success && <RegistrationSuccessToastr content={searchParamsObject} />}
        </>
    )
}

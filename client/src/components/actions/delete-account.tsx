...
import deleteUseAccount from "@/actions/user/delete-use-account"
...
export default function DeleteAccount() {
    ...
    async function handleDeleteAccount() {
        ...
        const state = await deleteUseAccount()
    ...
    return (
        <>
            <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-8 px-4 sm:px-6 md:grid-cols-3 lg:px-8">
                <div>
                    <h2 className="text-base font-semibold leading-7 text-gray-900">Delete account</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-400">
                        No longer want to use Taskr? You can delete your account here. This action is not reversible.
